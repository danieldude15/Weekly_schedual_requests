...
שם פרטי: <input type="text" name="f_name" value=""> 
שם משפחה: <input type="text" name="l_name" value=""> <br>
קבוצה: <input type="text" name="teamnum" value="">
מספר ברשימה: <input  type="text" name="indexG" value=""><br>
משמרות בשבוע: <input  type="text" name="misra" value="">
...
<?php if (isset($nightsuper) && $nightsuper==="0"){ echo "checked";}?>
value="0">לא
<input type="submit" value="הוסף\ערוך עובד\ת">
</form>
<p>
    הסבר קצר על אפשרות הוספה\עריכה של עובדים.<br>
    במידה ושם המשתמשם שהזנת קיים במערכת, יעודכנו רק הפרטים שמילאת.<br>
    אם שם המשתמש שתזיני לא קיים, המערכת תיצור משתמש חדש עם הפרטים שתמלאי בשדות הנ"ל<br>
</p>
</div>
...
<!--			     		יצירת סידור עבודה!!!  					
<div class="admin_box">
<h3>סידור ממוחשב! בבניה....</h3>
<form action="make_sidur.php" method="post">
    לשבוע שמתחיל ב: <input  type="date" name="week" value="" required>
<input type="submit" value="הכנת סידור" >
</form>
</div>
-->
<div class="admin_box">
